...
class testMCTS(unittest.TestCase):
    ...
    def test_leavesempty(self):
        ...
        mcts_lib.backprop(root.branches[0])
    ...
    def test_select_ucb(self):
        ...
        selected_node = mcts_lib.select_best(self.je, 2)
...
class testMCST_c4(unittest.TestCase):
    ...
    def test_expandsimulate(self):
        ...
        sel_node = mcts_lib.select_best(root)
        self.assertEqual(sel_node, root)
        select_sim = mcts_lib.expand(sel_node)
        self.assertEqual(len(root.branches), 7)
        mcts_lib.simulate(select_sim)
        mcts_lib.backprop(select_sim)
        self.assertEqual(select_sim.visits, 1)
        mcts_lib.select_best(root)
    ...
    def test_squil(self):
        ...
        idx = algos.mcts(root, algos.PLAYER_2, 15)

        self.assertEqual(idx, 2)


class testMCTS_ms(unittest.TestCase):
    ...
    def test_ms(self):
        ...
        root = tree.Node(board, -1)
        idx = algos.mcts_ms(root, algos.PLAYER_2, 15)
